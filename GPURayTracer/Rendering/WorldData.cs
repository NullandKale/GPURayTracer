...
namespace GPURayTracer.Rendering
{
    public class WorldData
    {
        ...
        public WorldData(Accelerator device)
        {
            ...
            worldBuffer.addGPUMesh(MeshLoader.LoadMeshFromFile(new Vec3(0, -65.5, 2), this, "Assets/defaultcube/defaultcube"));
            ...
            worldBuffer.addSphere(new Sphere(new Vec3(0, -1000, 0), 10f, worldBuffer.addMaterial(MaterialData.makeLight(new Vec3(1, 1, 1)))));
            ...
            worldBuffer.addSphere(new Sphere(new Vec3(1.5, -65, -1), 0.5f, worldBuffer.addMaterial(MaterialData.makeGlass(new Vec3(0.99f, 0.99f, 0.99f), 1.3f))));
            worldBuffer.addSphere(new Sphere(new Vec3(-1.5, -65, -1), 0.5f, worldBuffer.addMaterial(MaterialData.makeMirror(new Vec3(0.99f, 0.99f, 0.99f), 0f))));
            ...
            for (int i = 0; i < 25; i++)
            {
                ...
                Vec3 pos = new Vec3((random.NextDouble() * 10f) - 5f, size / 2f - 65f, (random.NextDouble() * 10f) - 5f);
